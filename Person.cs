...
public abstract class Person
{
    ...
    // Konstruktor
    protected Person(string firstName, string lastName) // durch die Verwendung von protected wird sichergestellt, dass nur abgeleitete Klassen auf den Konstruktor zugreifen können
    {
        FirstName = firstName;
        LastName = lastName;
    }
