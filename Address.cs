...
/// <summary>
/// Klasse zur Darstellung einer Adresse, erbt von Person.
/// </summary>
public class Address : Person { 
    ...
    {
        get => _phoneNumber; // trennt variable von Rückgabewert (Lambda Ausdruck)
        set
        {
            if (string.IsNullOrWhiteSpace(value))
            {
            ...
            else if (!Regex.IsMatch(value, @"^\+?[0-9]{10,15}$"))
            {
                throw new ArgumentException("Die Telefonnummer muss zwischen 10 und 15 Ziffern enthalten und kann mit einem '+' beginnen.");
            }
